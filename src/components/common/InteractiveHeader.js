...
const InteractiveHeader = (props) => {
  ...
  const { isPlanningStarted, startPlanning } = useTravelData();
  ...
  const videos = [
    {
      id: "video14",
      src: "/videos/pamplona-runningofbulls.mp4",
    ...
    {
      id: "video3",
      src: "/videos/zurich-river-tower.mp4",
      name: "Zurich River",
      orientation: "portrait",
      location: "Zurich",
      month: "July",
    ...
    {
      id: "video5",
      src: "/videos/paris-notre-dame.mp4",
      name: "Notre Dame",
      orientation: "portrait",
      location: "Paris",
      month: "October",
    ...
    {
      id: "video6",
      src: "/videos/florence-pontevechio.mp4",
      name: "Ponte Vecchio",
      orientation: "portrait",
      location: "Florence",
      month: "August",
    ...
    {
      id: "video8",
      src: "/videos/cote-dazur-pano.mp4",
      name: "Côte d'Azur",
      orientation: "portrait",
    ...
    {
      id: "video9",
      src: "/videos/piran-waterfront.mp4",
      name: "Piran Waterfront",
      orientation: "portrait",
      location: "Piran",
      month: "July",
      country: "Slovenia",
    ...
    {
      id: "video10",
      src: "/videos/paris-pont-des-arts.mp4",
      name: "Pont des Arts",
      orientation: "portrait",
      location: "Paris",
      month: "September",
    ...
    {
      id: "video11",
      src: "/videos/venice-boat-taxi.mp4",
      name: "Venice Boat Taxi",
      orientation: "portrait",
      location: "Venice",
      month: "April",
      country: "Italy",
    ...
    {
      id: "video12",
      src: "/videos/ljubljana-canal.mp4",
      name: "Ljubljana Canal",
      orientation: "portrait",
      location: "Ljubljana",
      month: "June",
      country: "Slovenia",
    ...
    {
      id: "video13",
      src: "/videos/paris-saint-germain-des-pres.mp4",
  ...
  const currentVideos = visibleIndices.map(
    (idx) => processedVideos[idx % processedVideos.length]
  );
  ...
  const handlePrevVideo = (e) => {
    ...
    requestAnimationFrame(() => {
      ...
      setVisibleIndices((current) => {
        return current.map(
          (idx) => (idx - 1 + processedVideos.length) % processedVideos.length
        );
      });
  ...
  const handleDotClick = (idx) => {
    ...
    const distanceRight =
      (idx - currentFirstIdx + processedVideos.length) % processedVideos.length;
    const distanceLeft =
      (currentFirstIdx - idx + processedVideos.length) % processedVideos.length;
  ...
  return (
    <div className="relative">
      ...
      <div className="relative h-screen max-h-[800px] w-full overflow-hidden bg-gradient-to-b from-black via-slate-900 to-slate-50">
              ...
              >
                <div
                  className={`h-full w-full transition-all duration-500 ${
                    hoveredVideo === `video-${visibleIndices[idx]}`
                      ? "scale-[1.02]"
                      : ""
                  }`}
                  onMouseEnter={() =>
                    handleMouseEnter(`video-${visibleIndices[idx]}`)
                  }
                ...
                >
                  <video
                    ...
                    ref={(el) => {
                      if (el)
                        videoRefs.current[`video-${visibleIndices[idx]}`] = el;
                    }}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-black to-transparent text-white">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-base font-medium opacity-80 mt-1">
                          {video.country}
                        </p>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <div className="text-center mb-8 px-4">
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto drop-shadow-md">
              Discover iconic cities, hidden gems, and seamless travel
          ...
          <div className="flex flex-col sm:flex-row gap-4 z-10">
            <motion.button
              ...
              className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-lg font-semibold shadow-lg"
            ...
            <Link href="/city-guides">
              <motion.button
                className="px-6 py-3 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white rounded-lg text-lg font-semibold shadow-lg"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Explore City Guides
        ...
        {/* Filter Overlay - only shown when planning has started */}
        {isPlanningStarted && (
