 ...
 */
export default function PushMock({ pushLine, time = '8:02', label = 'now', persona }) {
  return (
        ...
        <div className="overflow-hidden rounded-[1.9rem] bg-[radial-gradient(120%_80%_at_50%_0%,#3b4a6b_0%,#1e2436_70%)] px-3 pb-6 pt-10">
          ...
          <div className="animate-fade-in rounded-2xl bg-white/12 p-3 backdrop-blur-md ring-1 ring-white/10">
            <div className="mb-1.5 flex items-center gap-2">
              <AgentMark persona={persona || undefined} size={20} />
              <span className="text-[11px] font-semibold uppercase tracking-wide text-white/80">{persona?.name || 'Olivier'}</span>
