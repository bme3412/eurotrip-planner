...
export default function ShareButtons({ 
  ...
  const shareTitle = title || `${cityName} Travel Guide`;
  const shareDescription = description || `Discover the best of ${cityName} with our comprehensive travel guide`;
  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-gray-700 font-medium text-sm shadow-sm"
      >
          ...
          <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-50 p-3">
            <div className="space-y-1">
              ...
              >
                ...
                <span className="text-sm text-gray-700 group-hover:text-gray-900">X (Twitter)</span>
              </button>
