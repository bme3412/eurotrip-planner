...
export const getCitiesData = () => {
  return [
    ...
    // CZECH REPUBLIC
    {
      ...
      thumbnail: "/images/city-placeholder.svg",
    ...
    },
    {
      ...
      region: "Central Europe",
      description:
        "Brno, the Czech Republic's second-largest city, is the capital of Moravia region and a gateway to South Moravian wine country. Known for UNESCO World Heritage Villa Tugendhat, historic Špilberk Castle, and vibrant university life.",
      thumbnail: "/images/city-placeholder.svg",
      landmarks: ["Špilberk Castle", "Villa Tugendhat", "Cathedral of St. Peter and Paul", "Zelný trh Market"],
      latitude: 49.1951,
      longitude: 16.6068,
      tourismCategories: ["Historical Landmarks", "Cultural", "Architecture", "Food & Wine", "University Towns"],
      linguisticCategories: ["Slavic"],
    },
    {
      id: "pilsen",
    ...
    },
    {
      ...
      region: "Central Europe",
      description:
        "Olomouc, a historic Moravian city, features the UNESCO-listed Holy Trinity Column and beautiful baroque architecture. Known for its university atmosphere and authentic Czech character.",
      thumbnail: "/images/city-placeholder.svg",
      landmarks: ["Holy Trinity Column", "Olomouc Town Hall", "St. Wenceslas Cathedral"],
      latitude: 49.5938,
      longitude: 17.2509,
      tourismCategories: ["Historical Landmarks", "Cultural", "University Towns"],
      linguisticCategories: ["Slavic"],
    },
    {
      id: "ostrava",
      ...
      region: "Central Europe",
      description:
        "Ostrava, Czech Republic's third-largest city, has transformed from an industrial center into a vibrant cultural hub known for its unique post-industrial architecture and mining heritage.",
      thumbnail: "/images/city-placeholder.svg",
      landmarks: ["Dolní Vítkovice", "New City Hall", "Stodolní Street"],
      latitude: 49.8209,
      longitude: 18.2625,
      tourismCategories: ["Industrial Heritage", "Cultural", "Architecture", "Nightlife"],
      linguisticCategories: ["Slavic"],
    },
    {
      id: "hradec-kralove",
      ...
      region: "Central Europe",
      description:
        "Hradec Králové, known as the 'Queen of Czech Cities,' combines Gothic and modern architecture in a beautiful setting at the confluence of two rivers.",
      thumbnail: "/images/city-placeholder.svg",
      landmarks: ["Cathedral of the Holy Spirit", "White Tower", "Modern Art Gallery"],
      latitude: 50.2103,
      longitude: 15.8327,
      tourismCategories: ["Historical Landmarks", "Architecture", "Cultural"],
      linguisticCategories: ["Slavic"],
    },
    {
      id: "liberec",
      ...
      region: "Central Europe",
      description:
        "Liberec, set in the foothills of the Sudeten Mountains, is known for its textile heritage, winter sports, and proximity to stunning natural landscapes.",
      thumbnail: "/images/city-placeholder.svg",
      landmarks: ["Ještěd Tower", "Liberec Town Hall", "North Bohemian Museum"],
      latitude: 50.7663,
      longitude: 15.0566,
      tourismCategories: ["Natural Landscapes", "Adventure", "Historical Landmarks"],
      linguisticCategories: ["Slavic"],
    },
